...
new Vue({
  ...
  mounted: function mounted() {
    ...
    _axios2.default.get("../blogs/list.json?21321312").then(function (response) {
      ...
      if (parameters.tag) {
        ...
        var indexOf = _this.selectedTag.indexOf(tag);
        _this.selectidx = indexOf >= 0 ? indexOf : 2;
        return;
      }
    });
  }
