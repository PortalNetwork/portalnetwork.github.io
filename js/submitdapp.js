...
new Vue({
  ...
  methods: {
    ...
    onSubmit: function onSubmit() {
      ...
      _axios2.default.post('https://ip41ye507l.execute-api.us-east-1.amazonaws.com/dev/v1/proxy/insert-shortcase', data).then(function (response) {
        alert('Successful');
  ...
  watch: {
    email: function email() {
      var isText = /^\w+((-\w+)|(\.\w+))*\@[A-Za-z0-9]+((\.|-)[A-Za-z0-9]+)*\.[A-Za-z]+$/;
