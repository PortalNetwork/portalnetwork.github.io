    ...
    computed: {
        caseInfoArr: function caseInfoArr() {
            ...
            var CASE = this.showcaseInfo.filter(function (item, index, array) {
                return item.tag === _this.selectState[_this.selectidx];
            });
            return CASE;
        },
