...
new Vue({
    ...
    data: {
        showcaseInfo: [],
        selectidx: 2,
        selectState: ["aboutme", "hackathon", "dapp", "rise", "otherdweb", "wanchain", "wanchain_speaker"],
        shareOpen: false,
        m_open: false,
    ...
    methods: {
        ...
        caseSuccess: function caseSuccess(res) {
            ...
            this.isLoad = false;
            res.data.result.map(function (obj) {
...
},{"animated-scroll-to":2,"axios":3}],2:[function(require,module,exports){
(function() {
  'use strict';
