  ...
  export default {
    ...
    methods: {
      ...
      parallaxStart(){
        ...
        // return document.querySelector(".header").offsetHeight + (document.querySelector(".hero").offsetHeight + document.querySelector(".what").offsetHeight - 224);
      },
      GetOffset(el) {
      ...
      scrollFn(){
        ...
        const docH = document.documentElement.scrollHeight - this.getHeight() + 200;
        const docH2 = document.documentElement.scrollHeight - this.getHeight() + 300;
        const docH3 = document.documentElement.scrollHeight - this.getHeight() + 400;
        ...
        let percent2 = (scrollTop - this.GetOffset(document.querySelector(".bns")).top) / (docH2 - windowHeight);
